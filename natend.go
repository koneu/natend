...
func (nativeEndian) PutUint16(b []byte, v uint16) {
	_ = b[1]
	*(*uint16)(unsafe.Pointer((*reflect.SliceHeader)(unsafe.Pointer(&b)).Data)) = v
}

func (nativeEndian) PutUint32(b []byte, v uint32) {
	_ = b[3]
	*(*uint32)(unsafe.Pointer((*reflect.SliceHeader)(unsafe.Pointer(&b)).Data)) = v
}

func (nativeEndian) PutUint64(b []byte, v uint64) {
	_ = b[7]
	*(*uint64)(unsafe.Pointer((*reflect.SliceHeader)(unsafe.Pointer(&b)).Data)) = v
}
